...
conexion.execute("Insert into alumnos(nombre,edad) values(2,2)", ("Juan", 32))
conexion.execute("Insert into alumnos(nombre,edad) values(3,3)", ("Pablo", 18))
conexion.execute("Insert into alumnos(nombre,edad) values(4,4)", ("Eduardo", 12))
conexion.execute("Insert into alumnos(nombre,edad) values(5,5)", ("Luis", 19))
conexion.execute("Insert into alumnos(nombre,edad) values(6,6)", ("Fernando", 20))
